...
public class MiniBank implements MiniBankRemote, MiniBankLocal {
	...
	/**
	 * Deposit with a user-defined log date. Only used for generating test
	 * data
	 */
	@Override
	@TransactionAttribute(value = TransactionAttributeType.REQUIRES_NEW)
...
System.out.println("ACCOUNT FOUND: " + acc);
	...
	/**
	 * Withdraw with a user-defined log date. Only used for generating test
	 * data
	 */
	@Override
	@TransactionAttribute(value = TransactionAttributeType.REQUIRES_NEW)
	...
	/**
	 * Transfer with a user-defined log date. Only used for generating test
	 * data
	 */
	@Override
	@TransactionAttribute(value = TransactionAttributeType.REQUIRES_NEW)
